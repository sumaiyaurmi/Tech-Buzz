            ...
            <tbody>
              {products.map((product, index) => (
                <tr key={product._id}>
                  ...
                  <td><button className='bg-slate-400  px-4 py-2 text-lg btn text-center font-semibold  rounded-xl'><TbListDetails></TbListDetails></button></td>
                  <td className="">
                    <button className="bg-yellow-500 px-4 py-2 text-lg btn text-center font-semibold  rounded-xl">
                  ...
                  <td>
                    ...
                    disabled={product.status == 'accepted'}
                      onClick={() => handleStaus(product,product.status,'accepted')}
...
Accept
                  ...
                  disabled={product.status === 'rejected'}
                      onClick={() => handleStaus(product,product.status,'rejected')}
