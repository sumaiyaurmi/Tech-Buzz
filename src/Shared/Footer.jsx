...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">Product Discovery</a>
    <a className="link link-hover">Upvote & Review</a>
    <a className="link link-hover">Premium Membership</a>
  ...
  <nav>
    ...
    <a className="link link-hover">123 Tech Street</a>
    <a className="link link-hover">Innovation City, TC 12345</a>
